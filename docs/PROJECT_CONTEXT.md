...
按 D-015，当前优先验证 Android 官方网页登录与 B服绑定授权，URL 入口保留。2026-09-06 用户 U-002 已在手机浏览器登录官网并看到绑定的 B服终末地角色；这是页面和绑定可见性的用户实测，不代表网页能够返回授权凭据或拉取寻访记录，也未开发 APK。现有共享核心与本地存储目标保持适用。
