...
用户 U-001 报告断网后仅“网络异常”、无完整地址，渠道和版本待确认。2026-09-06，用户 U-002 报告可在手机浏览器登录官方用户中心，并看到已绑定的 B服终末地角色；未提供秘密数据，开发侧未读取会话。当前优先调查下方官方网页登录与绑定流程能否在 Android 完成，先验证登录页面、绑定前提和安全授权返回，再接共享同步核心。不能假设网页登录已经支持 B服或已有可安装 APK。
